            ...
            <div class="row px-xl-5">
                    ...
                    >
                        ...
                        <div class="carousel-inner">
                            ...
                            >
                                <img
                                    class="position-absolute w-100 h-100"
                                    src="assets/assets/img/carousel-3.jpg"
                                    style="object-fit: cover"
                                />
                                <div
                                    class="carousel-caption d-flex flex-column align-items-center justify-content-center"
                ...
                <div class="col-lg-4">
                    <div class="product-offer mb-30" style="height: 200px">
                        <assets/img class="img-fluid" src="assets/img/offer-1.jpg" alt="" />
        ...
        <div class="container-fluid pt-5">
            <div class="row px-xl-5 pb-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    ...
                    >
                        <h1
                            class="fa fa-shipping-fast text-primary m-0 mr-2"
                        ></h1>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    ...
                    >
                        <h1
                            class="fas fa-exchange-alt text-primary m-0 mr-3"
                        ></h1>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    ...
                    >
                        <h1
                            class="fa fa-phone-volume text-primary m-0 mr-3"
                        ></h1>
                    ...
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            ...
                            >
                                ...
                                ></small>
                                <small
                                    class="far fa-star text-primary mr-1"
                                ></small>
                                <small>(99)</small>
                            </div>
                        </div>
